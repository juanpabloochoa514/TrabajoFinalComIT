...
//import repositories.AlimentosCongRepository;
...
public class addFrozen extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			AlimentoCongelado alimentoC =new AlimentoCongelado (ingresarC, cantidadCong);
			
		
			
			int id = CommonRepository.ALimentosCongeladosRepoName.addNewCongelado(alimentoC);
			alimentoC.setIdCong(id);
